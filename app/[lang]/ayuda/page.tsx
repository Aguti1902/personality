...
export default function AyudaPage() {
  ...
  const categories = [
    ...
    },
    {
      ...
      title: 'Conéctate con el soporte de Personality Insight',
      description: 'Nuestro equipo está aquí para ayudarte',
      color: 'from-[#FF852A] to-[#cc6a22]',
      links: [
        { title: 'Contacta con el soporte de Personality Insight', href: `/${lang}/contacto` }
      ]
    }
  ]
        ...
        <div className="container-custom max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-4">
              Centro de ayuda Personality Insight
            </h1>
          ...
          <div className="space-y-12">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="prose max-w-none">
                  ...
                  <ol className="list-decimal pl-6 space-y-3 text-gray-700">
                    <li>Inicia sesión en tu cuenta de Personality Insight</li>
            ...
            <section id="renovacion" className="scroll-mt-20">
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="prose max-w-none">
                  <p className="text-gray-700 mb-4">
                    Sí, tu suscripción a Personality Insight se renueva automáticamente al final de cada período de facturación 
            ...
            <section id="cargo" className="scroll-mt-20">
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="prose max-w-none">
                  ...
                  <ol className="list-decimal pl-6 space-y-3 text-gray-700">
                    <li>
                      <strong>Verifica el cargo:</strong> Revisa tu historial de pagos en tu cuenta de Personality Insight
                    </li>
                    <li>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="prose max-w-none">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mt-6 rounded-r-lg">
                    ...
                    <p className="text-blue-800">
                      Te recomendamos agregar nuestro email (support@personalityinsight.com) a tu lista de contactos 
          ...
          {/* Contact CTA */}
          <div className="mt-16 bg-gradient-to-r from-[#224469] to-[#14283f] rounded-2xl shadow-2xl p-12 text-center text-white">
            <FaHeadset className="text-6xl mx-auto mb-6 text-[#FF852A]" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() => router.push(`/${lang}/cuenta`)}
                className="bg-white text-[#224469] hover:bg-gray-100 px-8 py-4 rounded-lg font-bold text-lg transition-all"
              >
                Ver Mi Cuenta
              </button>
            </div>
            <p className="mt-6 text-sm opacity-75">
              Email: <a href="mailto:support@personalityinsight.com" className="underline">support@personalityinsight.com</a>
            </p>
          </div>
        </div>
      </div>
